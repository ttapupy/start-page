...
const Header: FC<HeaderProps> = ({ onCheck, selectedFeeds, sourceEntries }) => {
  ...
  return (
    <>
      ...
      <header className={`fixed top-0 z-[900] flex h-[4em] w-full justify-between bg-stone-400 dark:bg-stone-800 transition-all duration-500 ${scrollDown && 'scroll-down'}`}>
        <FeedSelector
          onCheck={onCheck}
